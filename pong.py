...
while True:
    ...
    #Score and Border X cheking
    if ball.xcor() > 390:
        ball.goto(0,0)
        ball.dx *= -1
        score_a += 1 #update a score
        pen.clear() #clear the previous score
        pen.write("PlayerA: {}  PlayerB: {}".format(score_a,score_b),align="center",font=("Courier",24,"normal")) #print the new score

    if ball.xcor() < -390:
        ball.goto(0,0)
        ball.dx *= -1
        score_b += 1 #update the score
        pen.clear() #clear the previous score
        pen.write("PlayerA: {}  PlayerB: {}".format(score_a,score_b),align="center",font=("Courier",24,"normal")) #print the new score
